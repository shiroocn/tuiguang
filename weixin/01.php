...
<head>
    ...
    <title>行情不好？试试“期货现货价差无风险套利”_真正一线套利商的独门秘籍</title>
    <?php include ('./public/css.php')?>
</head>
<body>
<div class="s-title">行情不好？试试“期货现货价差无风险套利”_真正一线套利商的独门秘籍</div>
<div class="s-author">
    <a href="#"><?php echo($init['name']); ?></a>
    <span class="a">昨天</span>
</div>
<div class="s-content">

    <p class="pc_font_b" style="text-align: center;color:red; ">官方在线指导微信号【<span class="user-wx"><?php echo($init['wx']); ?></span>】（期货技巧/期货入门）</p>
